...
A view of the absolute figures of all vaccination categories, including **"Unknown"**, i.e. not reported. [^1]

[^1]: *UPDATE 2022-11: as it can be seen from the large numbers in the Unknown category, BAG does not keep track properly any more of the vaccination status.*
...
Even with some deficiency in the data, this analysis clearly shows the benefits of vaccination and what could have happened in Switzerland if vaccines had been unavailable.[^2]

[^2]: *Please note that the data collection from BAG was sufficiently accurate until September 2022, therefore the historical comparisons of this report from 2022Q2 onwards are less meaningful.*
