...
#   }
#   if (!("package:covid19vaccinationchqmd" %in% search())) {
#     library(covid19vaccinationchqmd)
#   }
#   NULL
# }
    pkgload::load_all(export_all = FALSE, helpers = FALSE, attach_testthat = FALSE)
...
# saveRDS(last_timeline_weeks, "last_timeline_weeks.rds") 
...
file.remove(c("data1.rds", "data2.rds"))
